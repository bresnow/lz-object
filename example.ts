import { lzObject } from "./src/index";
...
let compressedUri = lzObject.compress(dummy, { output: "uri" });
console.group("COMPRESSED")
console.group("encoded uri component")
console.log(compressedUri)
console.groupEnd()
let compreddUint8 = lzObject.compress(dummy, { output: "uint8array" });
console.group("uint8array indexed into object")
console.log(compreddUint8)
console.groupEnd()
console.group("utf16")
let compressedUtf16 = lzObject.compress(dummy, { output: "utf16" });
console.log(compressedUtf16)
console.groupEnd()
console.group("base64")
let compressedB64 = lzObject.compress(dummy, { output: "base64" });
